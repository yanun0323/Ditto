...
extension View {
    public func font(name font: DittoFont.Font, size: CGFloat) -> some View {
        self.font(.custom(font.name, size: size))
    }
    
    public func font(name font: DittoFont.Font, _ style: Font.TextStyle = .body) -> some View {
...
#if DEBUG
#Preview {
    DittoFont.registerFonts([.Roboto, .Cubic11R])
    return FontTestView(26, .largeTitle, font: .Cubic11R)
}

func FontTestView(_ size: CGFloat, _ style: Font.TextStyle, font: DittoFont.Font) -> some View {
    VStack {
        Text("Font Test 測試")
